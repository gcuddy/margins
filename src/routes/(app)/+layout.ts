...
export const load = (async (e) => {
    ...
    const subscriptions_data = utils.subscriptions.list.getData() ?? utils.subscriptions.list.fetch();
    const [user, states, tags, subscriptions] = await Promise.all([user_data, states_data, tags_data, subscriptions_data]);
