<script lang="ts">
    ...
    let files = []
	async function iterateThroughDirectory(directoryHandle: FileSystemDirectoryHandle) {
...
Garden allows you to store your digital garden here. You can keep it local by linking a local folder of
markdown files. Or you can store it here.
