			...
			>
				<div class="space-y-4">
					...
					<div class="flex flex-col">
						...
						<MobileLink
                            bind:open={isAddSheetOpen} href="/search?type=movie">
							<EntryIcon type="movie" class="w-5 h-5 mr-2" />
							Movie or TV Show
						</MobileLink>
						<MobileLink
                            bind:open={isAddSheetOpen} href="/search?type=books">
							<EntryIcon type="book" class="w-5 h-5 mr-2" />
							Book
						</MobileLink>
						<MobileLink
                            bind:open={isAddSheetOpen} href="/search?type=podcasts">
							<EntryIcon type="podcast" class="w-5 h-5 mr-2" />
							Podcast
						</MobileLink>
						<MobileLink
                            bind:open={isAddSheetOpen} href="/search?type=music">
