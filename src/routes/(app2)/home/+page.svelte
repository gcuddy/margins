...
<div class="overflow-x-hidden">
	<div class="flex items-center justify-between">
		...
		<DropdownMenu>
			...
			<DropdownMenuContent>
				<DropdownMenuItem on:click={() => goto('/home/edit')}>Edit</DropdownMenuItem>
			</DropdownMenuContent>
		</DropdownMenu>
	</div>
	<H2>Recents</H2>
	...
	>
		{#each data.recents as recent}
			<a href="/{recent.type}/{getId(recent)}" class="w-36 shrink-0 snap-start space-y-3 p-2">
				<img
