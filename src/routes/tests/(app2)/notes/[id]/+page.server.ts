...
import { annotations, entrySelect, genericWithEntry, withEntry } from '$lib/db/selects';
...
export const load = (async ({ locals, params }) => {
    ...
    const { id } = params;
    const note = await db.selectFrom("Annotation as a")
        .select(["id", "title", "body", "userId", "deleted"])
