<script lang="ts">
	...
	const tabs = ['Subscriptions', 'Latest', 'Podcasts'];
...
<!-- <div class="mt-4">
	<Tabs
		tabs={[
			{ name: 'Subscriptions', href: '/tests/subscriptions' },
			{ name: 'Latest', href: '/tests/subscriptions/latest' },
			{ name: 'Podcasts', href: '/tests/subscriptions/podcasts' }
		]}
	/>
</div> -->
