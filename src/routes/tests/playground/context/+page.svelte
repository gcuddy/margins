...
<style lang="postcss">
	...
	.item {
		...
		@apply text-stone-900 z-20 outline-none;
		@apply data-[highlighted]:bg-stone-200 data-[highlighted]:text-stone-900;
	...
	.check {
		@apply text-stone-500 absolute left-2 top-1/2;
		translate: 0 calc(-50% + 1px);
	}

	.dot {
		@apply bg-stone-900 h-[4.75px] w-[4.75px] rounded-full;
	}

	.separator {
		@apply bg-stone-200 m-[5px] h-[1px];
	}
