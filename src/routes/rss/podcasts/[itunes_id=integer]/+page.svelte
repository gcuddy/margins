<script lang="ts">
	...
	$: ({ title, imageUrl: image, description, feedUrl: url, items, creator, id } = data);
	$: console.log({ data });
	let existing = false;
