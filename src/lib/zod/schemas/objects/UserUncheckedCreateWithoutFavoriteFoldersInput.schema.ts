...
import { ContextUncheckedCreateNestedManyWithoutUserInputObjectSchema } from './ContextUncheckedCreateNestedManyWithoutUserInput.schema';
...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutFavoriteFoldersInput> = z
	.object({
		...
		EntryTag: z
			...
			.optional(),
		context: z.lazy(() => ContextUncheckedCreateNestedManyWithoutUserInputObjectSchema).optional(),
		context_nodes: z
...
export const UserUncheckedCreateWithoutFavoriteFoldersInputObjectSchema = Schema;
