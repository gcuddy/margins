...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutSubscriptionsInput> = z
	.object({
...
export const UserUncheckedCreateWithoutSubscriptionsInputObjectSchema = Schema;
