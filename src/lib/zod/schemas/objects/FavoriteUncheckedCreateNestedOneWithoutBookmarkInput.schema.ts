...
const Schema: z.ZodType<Prisma.FavoriteUncheckedCreateNestedOneWithoutBookmarkInput> = z
	.object({
		create: z
			.union([
...
export const FavoriteUncheckedCreateNestedOneWithoutBookmarkInputObjectSchema = Schema;
