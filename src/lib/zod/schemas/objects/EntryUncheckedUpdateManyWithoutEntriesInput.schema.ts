...
const Schema: z.ZodType<Prisma.EntryUncheckedUpdateManyWithoutEntriesInput> = z
	.object({
		createdAt: z
...
export const EntryUncheckedUpdateManyWithoutEntriesInputObjectSchema = Schema;
