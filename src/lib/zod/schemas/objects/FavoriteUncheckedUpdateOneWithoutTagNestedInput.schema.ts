...
const Schema: z.ZodType<Prisma.FavoriteUncheckedUpdateOneWithoutTagNestedInput> = z
	.object({
		create: z
			.union([
...
export const FavoriteUncheckedUpdateOneWithoutTagNestedInputObjectSchema = Schema;
