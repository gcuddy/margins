...
const Schema: z.ZodType<Prisma.AnnotationUncheckedCreateWithoutParentInput> = z
	.object({
...
export const AnnotationUncheckedCreateWithoutParentInputObjectSchema = Schema;
