...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutDefault_stateInput> = z
	.object({
...
export const UserUncheckedCreateWithoutDefault_stateInputObjectSchema = Schema;
