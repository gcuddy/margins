...
const Schema: z.ZodType<Prisma.ArticleUncheckedUpdateManyWithoutArticlesInput> = z
	.object({
...
export const ArticleUncheckedUpdateManyWithoutArticlesInputObjectSchema = Schema;
