...
const Schema: z.ZodType<Prisma.TaggingUncheckedUpdateManyWithoutBookmarkNestedInput> = z
	.object({
		create: z
			.union([
...
export const TaggingUncheckedUpdateManyWithoutBookmarkNestedInputObjectSchema = Schema;
