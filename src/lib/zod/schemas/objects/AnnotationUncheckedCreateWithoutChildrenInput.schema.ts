...
const Schema: z.ZodType<Prisma.AnnotationUncheckedCreateWithoutChildrenInput> = z
	.object({
...
export const AnnotationUncheckedCreateWithoutChildrenInputObjectSchema = Schema;
