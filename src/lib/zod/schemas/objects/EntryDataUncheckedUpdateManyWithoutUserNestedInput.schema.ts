...
const Schema: z.ZodType<Prisma.EntryDataUncheckedUpdateManyWithoutUserNestedInput> = z
	.object({
		create: z
			.union([
...
export const EntryDataUncheckedUpdateManyWithoutUserNestedInputObjectSchema = Schema;
