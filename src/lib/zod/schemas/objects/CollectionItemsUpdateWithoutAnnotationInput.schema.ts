...
const Schema: z.ZodType<Prisma.CollectionItemsUpdateWithoutAnnotationInput> = z
	.object({
		collection: z
...
export const CollectionItemsUpdateWithoutAnnotationInputObjectSchema = Schema;
