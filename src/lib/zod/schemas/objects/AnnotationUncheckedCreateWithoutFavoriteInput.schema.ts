...
const Schema: z.ZodType<Prisma.AnnotationUncheckedCreateWithoutFavoriteInput> = z
	.object({
...
export const AnnotationUncheckedCreateWithoutFavoriteInputObjectSchema = Schema;
