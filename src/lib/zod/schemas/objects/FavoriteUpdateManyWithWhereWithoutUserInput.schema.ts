...
const Schema: z.ZodType<Prisma.FavoriteUpdateManyWithWhereWithoutUserInput> = z
	.object({
...
export const FavoriteUpdateManyWithWhereWithoutUserInputObjectSchema = Schema;
