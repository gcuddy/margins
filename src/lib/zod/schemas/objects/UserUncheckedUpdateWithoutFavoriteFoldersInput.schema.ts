...
import { ContextNodeUncheckedUpdateManyWithoutOwnerNestedInputObjectSchema } from './ContextNodeUncheckedUpdateManyWithoutOwnerNestedInput.schema';

import type { Prisma } from '@prisma/client';

const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutFavoriteFoldersInput> = z
	.object({
		id: z
		...
		context_nodes: z
			.lazy(() => ContextNodeUncheckedUpdateManyWithoutOwnerNestedInputObjectSchema)
			.optional(),
	})
	.strict();

export const UserUncheckedUpdateWithoutFavoriteFoldersInputObjectSchema = Schema;
