...
const Schema: z.ZodType<Prisma.EntryUncheckedUpdateWithoutInteractionsInput> = z
	.object({
...
export const EntryUncheckedUpdateWithoutInteractionsInputObjectSchema = Schema;
