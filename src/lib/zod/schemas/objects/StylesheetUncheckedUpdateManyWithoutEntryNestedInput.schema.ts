...
const Schema: z.ZodType<Prisma.StylesheetUncheckedUpdateManyWithoutEntryNestedInput> = z
	.object({
		create: z
			.union([
...
export const StylesheetUncheckedUpdateManyWithoutEntryNestedInputObjectSchema = Schema;
