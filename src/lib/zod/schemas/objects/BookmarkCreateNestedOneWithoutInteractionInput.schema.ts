...
const Schema: z.ZodType<Prisma.BookmarkCreateNestedOneWithoutInteractionInput> = z
	.object({
		create: z
			.union([
...
export const BookmarkCreateNestedOneWithoutInteractionInputObjectSchema = Schema;
