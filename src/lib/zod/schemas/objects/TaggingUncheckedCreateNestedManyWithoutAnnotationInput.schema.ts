...
const Schema: z.ZodType<Prisma.TaggingUncheckedCreateNestedManyWithoutAnnotationInput> = z
	.object({
		create: z
			.union([
...
export const TaggingUncheckedCreateNestedManyWithoutAnnotationInputObjectSchema = Schema;
