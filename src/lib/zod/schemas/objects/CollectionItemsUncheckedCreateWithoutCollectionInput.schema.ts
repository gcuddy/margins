...
const Schema: z.ZodType<Prisma.CollectionItemsUncheckedCreateWithoutCollectionInput> = z
	.object({
...
export const CollectionItemsUncheckedCreateWithoutCollectionInputObjectSchema = Schema;
