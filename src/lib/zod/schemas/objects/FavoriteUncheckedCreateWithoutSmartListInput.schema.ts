...
const Schema: z.ZodType<Prisma.FavoriteUncheckedCreateWithoutSmartListInput> = z
	.object({
...
export const FavoriteUncheckedCreateWithoutSmartListInputObjectSchema = Schema;
