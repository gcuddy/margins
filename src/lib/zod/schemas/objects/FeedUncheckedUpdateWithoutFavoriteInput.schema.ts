...
import { SubscriptionUncheckedUpdateManyWithoutFeedNestedInputObjectSchema } from './SubscriptionUncheckedUpdateManyWithoutFeedNestedInput.schema';
...
const Schema: z.ZodType<Prisma.FeedUncheckedUpdateWithoutFavoriteInput> = z
	.object({
		...
		velocity: z
			...
			.nullable(),
		subscriptions: z
			.lazy(() => SubscriptionUncheckedUpdateManyWithoutFeedNestedInputObjectSchema)
			.optional(),
		context: z.lazy(() => ContextUncheckedUpdateManyWithoutFeedNestedInputObjectSchema).optional(),
	})
	.strict();

export const FeedUncheckedUpdateWithoutFavoriteInputObjectSchema = Schema;
