...
const Schema: z.ZodType<Prisma.SubscriptionUncheckedCreateNestedManyWithoutUserInput> = z
	.object({
		create: z
			.union([
...
export const SubscriptionUncheckedCreateNestedManyWithoutUserInputObjectSchema = Schema;
