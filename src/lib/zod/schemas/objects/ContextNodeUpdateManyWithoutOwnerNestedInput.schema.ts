...
const Schema: z.ZodType<Prisma.ContextNodeUpdateManyWithoutOwnerNestedInput> = z
	.object({
		create: z
			.union([
...
export const ContextNodeUpdateManyWithoutOwnerNestedInputObjectSchema = Schema;
