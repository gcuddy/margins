...
const Schema: z.ZodType<Prisma.InteractionUncheckedCreateNestedManyWithoutEntryInput> = z
	.object({
		create: z
			.union([
...
export const InteractionUncheckedCreateNestedManyWithoutEntryInputObjectSchema = Schema;
