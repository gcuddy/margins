...
const Schema: z.ZodType<Prisma.TaggingUncheckedUpdateManyWithoutFeedNestedInput> = z
	.object({
		create: z
			.union([
...
export const TaggingUncheckedUpdateManyWithoutFeedNestedInputObjectSchema = Schema;
