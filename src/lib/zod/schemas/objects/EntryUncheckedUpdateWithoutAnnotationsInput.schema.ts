...
const Schema: z.ZodType<Prisma.EntryUncheckedUpdateWithoutAnnotationsInput> = z
	.object({
...
export const EntryUncheckedUpdateWithoutAnnotationsInputObjectSchema = Schema;
