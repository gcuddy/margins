...
const Schema: z.ZodType<Prisma.EntryMediaUncheckedCreateNestedManyWithoutDocumentDataInput> = z
	.object({
		create: z
			.union([
...
export const EntryMediaUncheckedCreateNestedManyWithoutDocumentDataInputObjectSchema = Schema;
