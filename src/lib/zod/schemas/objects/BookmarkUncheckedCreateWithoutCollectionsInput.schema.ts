...
import { AnnotationUncheckedCreateNestedManyWithoutBookmarkInputObjectSchema } from './AnnotationUncheckedCreateNestedManyWithoutBookmarkInput.schema';
...
const Schema: z.ZodType<Prisma.BookmarkUncheckedCreateWithoutCollectionsInput> = z
	.object({
		...
		annotations: z
			.lazy(() => AnnotationUncheckedCreateNestedManyWithoutBookmarkInputObjectSchema)
			.optional(),
		deleted: z.date().optional().nullable(),
	})
	.strict();

export const BookmarkUncheckedCreateWithoutCollectionsInputObjectSchema = Schema;
