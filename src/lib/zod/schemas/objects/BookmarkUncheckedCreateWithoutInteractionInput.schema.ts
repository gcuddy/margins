...
const Schema: z.ZodType<Prisma.BookmarkUncheckedCreateWithoutInteractionInput> = z
	.object({
...
export const BookmarkUncheckedCreateWithoutInteractionInputObjectSchema = Schema;
