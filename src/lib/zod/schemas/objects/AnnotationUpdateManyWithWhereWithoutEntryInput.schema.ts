...
const Schema: z.ZodType<Prisma.AnnotationUpdateManyWithWhereWithoutEntryInput> = z
	.object({
...
export const AnnotationUpdateManyWithWhereWithoutEntryInputObjectSchema = Schema;
