...
const Schema: z.ZodType<Prisma.StateUncheckedCreateNestedManyWithoutUserInput> = z
	.object({
		create: z
			.union([
...
export const StateUncheckedCreateNestedManyWithoutUserInputObjectSchema = Schema;
