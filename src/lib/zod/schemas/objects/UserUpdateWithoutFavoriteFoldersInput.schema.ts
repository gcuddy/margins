...
const Schema: z.ZodType<Prisma.UserUpdateWithoutFavoriteFoldersInput> = z
	.object({
		id: z
		...
		following: z.lazy(() => UserUpdateManyWithoutFollowedByNestedInputObjectSchema).optional(),
...
export const UserUpdateWithoutFavoriteFoldersInputObjectSchema = Schema;
