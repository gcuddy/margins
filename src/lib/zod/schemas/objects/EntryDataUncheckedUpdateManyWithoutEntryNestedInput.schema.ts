...
const Schema: z.ZodType<Prisma.EntryDataUncheckedUpdateManyWithoutEntryNestedInput> = z
	.object({
		create: z
			.union([
...
export const EntryDataUncheckedUpdateManyWithoutEntryNestedInputObjectSchema = Schema;
