...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutInteractionsInput> = z
	.object({
...
export const UserUncheckedCreateWithoutInteractionsInputObjectSchema = Schema;
