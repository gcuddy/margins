...
const Schema: z.ZodType<Prisma.BookmarkUncheckedUpdateManyWithoutBookmarksInput> = z
	.object({
...
export const BookmarkUncheckedUpdateManyWithoutBookmarksInputObjectSchema = Schema;
