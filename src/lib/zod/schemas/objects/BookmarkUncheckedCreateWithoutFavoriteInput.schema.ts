...
const Schema: z.ZodType<Prisma.BookmarkUncheckedCreateWithoutFavoriteInput> = z
	.object({
...
export const BookmarkUncheckedCreateWithoutFavoriteInputObjectSchema = Schema;
