...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutInteractionsInput> = z
	.object({
		id: z
...
export const UserUncheckedUpdateWithoutInteractionsInputObjectSchema = Schema;
