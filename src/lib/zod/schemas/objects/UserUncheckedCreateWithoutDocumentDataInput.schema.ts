...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutDocumentDataInput> = z
	.object({
...
export const UserUncheckedCreateWithoutDocumentDataInputObjectSchema = Schema;
