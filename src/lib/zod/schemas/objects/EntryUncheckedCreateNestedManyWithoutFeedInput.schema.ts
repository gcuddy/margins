...
const Schema: z.ZodType<Prisma.EntryUncheckedCreateNestedManyWithoutFeedInput> = z
	.object({
		create: z
			.union([
...
export const EntryUncheckedCreateNestedManyWithoutFeedInputObjectSchema = Schema;
