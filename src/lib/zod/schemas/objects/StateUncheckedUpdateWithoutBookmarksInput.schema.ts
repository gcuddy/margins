...
import { UserUncheckedUpdateOneWithoutDefault_stateNestedInputObjectSchema } from './UserUncheckedUpdateOneWithoutDefault_stateNestedInput.schema';
import { DateTimeFieldUpdateOperationsInputObjectSchema } from './DateTimeFieldUpdateOperationsInput.schema';

import type { Prisma } from '@prisma/client';

const Schema: z.ZodType<Prisma.StateUncheckedUpdateWithoutBookmarksInput> = z
	.object({
		...
		userId: z
			...
			.optional(),
		defaultRelation: z
			.lazy(() => UserUncheckedUpdateOneWithoutDefault_stateNestedInputObjectSchema)
			.optional(),
		default: z
			.union([z.boolean(), z.lazy(() => BoolFieldUpdateOperationsInputObjectSchema)])
			.optional(),
...
export const StateUncheckedUpdateWithoutBookmarksInputObjectSchema = Schema;
