...
const Schema: z.ZodType<Prisma.CollectionItemsUncheckedUpdateWithoutAnnotationInput> = z
	.object({
...
export const CollectionItemsUncheckedUpdateWithoutAnnotationInputObjectSchema = Schema;
