...
const Schema: z.ZodType<Prisma.CollectionItemsCreateNestedManyWithoutCollectionInput> = z
	.object({
		create: z
			.union([
...
export const CollectionItemsCreateNestedManyWithoutCollectionInputObjectSchema = Schema;
