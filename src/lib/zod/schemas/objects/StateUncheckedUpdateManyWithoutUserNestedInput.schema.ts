...
const Schema: z.ZodType<Prisma.StateUncheckedUpdateManyWithoutUserNestedInput> = z
	.object({
		create: z
			.union([
...
export const StateUncheckedUpdateManyWithoutUserNestedInputObjectSchema = Schema;
