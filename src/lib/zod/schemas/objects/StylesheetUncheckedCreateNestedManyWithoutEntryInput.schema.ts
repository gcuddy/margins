...
const Schema: z.ZodType<Prisma.StylesheetUncheckedCreateNestedManyWithoutEntryInput> = z
	.object({
		create: z
			.union([
...
export const StylesheetUncheckedCreateNestedManyWithoutEntryInputObjectSchema = Schema;
