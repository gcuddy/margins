...
import { BookmarkCreateNestedOneWithoutAnnotationsInputObjectSchema } from './BookmarkCreateNestedOneWithoutAnnotationsInput.schema';
...
const Schema: z.ZodType<Prisma.AnnotationCreateWithoutCollectionsInput> = z
	.object({
		...
		bookmark: z.lazy(() => BookmarkCreateNestedOneWithoutAnnotationsInputObjectSchema).optional(),
	})
	.strict();

export const AnnotationCreateWithoutCollectionsInputObjectSchema = Schema;
