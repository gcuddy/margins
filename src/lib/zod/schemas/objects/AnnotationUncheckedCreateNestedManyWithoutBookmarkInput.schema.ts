...
const Schema: z.ZodType<Prisma.AnnotationUncheckedCreateNestedManyWithoutBookmarkInput> = z
	.object({
		create: z
			.union([
...
export const AnnotationUncheckedCreateNestedManyWithoutBookmarkInputObjectSchema = Schema;
