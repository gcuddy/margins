...
const Schema: z.ZodType<Prisma.CollectionUncheckedUpdateManyWithoutUserNestedInput> = z
	.object({
		create: z
			.union([
...
export const CollectionUncheckedUpdateManyWithoutUserNestedInputObjectSchema = Schema;
