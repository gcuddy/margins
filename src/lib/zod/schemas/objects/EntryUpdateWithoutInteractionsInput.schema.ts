...
import { ContextUpdateManyWithoutEntryNestedInputObjectSchema } from './ContextUpdateManyWithoutEntryNestedInput.schema';
...
const Schema: z.ZodType<Prisma.EntryUpdateWithoutInteractionsInput> = z
	.object({
		...
		context: z.lazy(() => ContextUpdateManyWithoutEntryNestedInputObjectSchema).optional(),
	})
	.strict();

export const EntryUpdateWithoutInteractionsInputObjectSchema = Schema;
