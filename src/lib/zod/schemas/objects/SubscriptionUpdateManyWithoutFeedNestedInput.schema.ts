...
const Schema: z.ZodType<Prisma.SubscriptionUpdateManyWithoutFeedNestedInput> = z
	.object({
		create: z
			.union([
...
export const SubscriptionUpdateManyWithoutFeedNestedInputObjectSchema = Schema;
