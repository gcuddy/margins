...
const Schema: z.ZodType<Prisma.FavoriteUncheckedCreateNestedManyWithoutUserInput> = z
	.object({
		create: z
			.union([
...
export const FavoriteUncheckedCreateNestedManyWithoutUserInputObjectSchema = Schema;
