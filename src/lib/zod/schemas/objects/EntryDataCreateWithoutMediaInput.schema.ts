...
import { EntryCreateNestedOneWithoutDataInputObjectSchema } from './EntryCreateNestedOneWithoutDataInput.schema';
...
const Schema: z.ZodType<Prisma.EntryDataCreateWithoutMediaInput> = z
	.object({
		...
		entry: z.lazy(() => EntryCreateNestedOneWithoutDataInputObjectSchema),
		user: z.lazy(() => UserCreateNestedOneWithoutDocumentDataInputObjectSchema),
	})
	.strict();

export const EntryDataCreateWithoutMediaInputObjectSchema = Schema;
