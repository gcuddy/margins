...
const Schema: z.ZodType<Prisma.FavoriteCreateNestedOneWithoutSmartListInput> = z
	.object({
		create: z
			.union([
...
export const FavoriteCreateNestedOneWithoutSmartListInputObjectSchema = Schema;
