...
const Schema: z.ZodType<Prisma.CollectionItemsCreateNestedManyWithoutBookmarkInput> = z
	.object({
		create: z
			.union([
...
export const CollectionItemsCreateNestedManyWithoutBookmarkInputObjectSchema = Schema;
