...
import { StateCreateNestedOneWithoutBookmarksInputObjectSchema } from './StateCreateNestedOneWithoutBookmarksInput.schema';
...
const Schema: z.ZodType<Prisma.BookmarkCreateWithoutCollectionsInput> = z
	.object({
		...
		state: z.lazy(() => StateCreateNestedOneWithoutBookmarksInputObjectSchema).optional(),
...
export const BookmarkCreateWithoutCollectionsInputObjectSchema = Schema;
