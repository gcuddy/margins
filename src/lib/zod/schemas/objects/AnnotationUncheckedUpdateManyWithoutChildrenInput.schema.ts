...
const Schema: z.ZodType<Prisma.AnnotationUncheckedUpdateManyWithoutChildrenInput> = z
	.object({
...
export const AnnotationUncheckedUpdateManyWithoutChildrenInputObjectSchema = Schema;
