...
const Schema: z.ZodType<Prisma.EntryMediaUpdateManyWithoutEntryNestedInput> = z
	.object({
		create: z
			.union([
...
export const EntryMediaUpdateManyWithoutEntryNestedInputObjectSchema = Schema;
