...
import { EntryUpdateOneWithoutAnnotationsNestedInputObjectSchema } from './EntryUpdateOneWithoutAnnotationsNestedInput.schema';
...
const Schema: z.ZodType<Prisma.AnnotationUpdateWithoutCollectionsInput> = z
	.object({
		createdAt: z
		...
		entry: z.lazy(() => EntryUpdateOneWithoutAnnotationsNestedInputObjectSchema).optional(),
...
export const AnnotationUpdateWithoutCollectionsInputObjectSchema = Schema;
