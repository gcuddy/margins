...
const Schema: z.ZodType<Prisma.FeedUncheckedCreateWithoutSubscriptionsInput> = z
	.object({
...
export const FeedUncheckedCreateWithoutSubscriptionsInputObjectSchema = Schema;
