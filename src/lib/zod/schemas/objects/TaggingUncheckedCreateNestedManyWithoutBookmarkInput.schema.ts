...
const Schema: z.ZodType<Prisma.TaggingUncheckedCreateNestedManyWithoutBookmarkInput> = z
	.object({
		create: z
			.union([
...
export const TaggingUncheckedCreateNestedManyWithoutBookmarkInputObjectSchema = Schema;
