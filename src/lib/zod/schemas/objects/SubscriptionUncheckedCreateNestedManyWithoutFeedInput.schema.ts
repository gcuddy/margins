...
const Schema: z.ZodType<Prisma.SubscriptionUncheckedCreateNestedManyWithoutFeedInput> = z
	.object({
		create: z
			.union([
...
export const SubscriptionUncheckedCreateNestedManyWithoutFeedInputObjectSchema = Schema;
