...
const Schema: z.ZodType<Prisma.AnnotationUncheckedCreateWithoutBookmarkInput> = z
	.object({
...
export const AnnotationUncheckedCreateWithoutBookmarkInputObjectSchema = Schema;
