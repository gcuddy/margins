...
const Schema: z.ZodType<Prisma.CollectionItemsUncheckedUpdateManyWithoutCollectionsInput> = z
	.object({
...
export const CollectionItemsUncheckedUpdateManyWithoutCollectionsInputObjectSchema = Schema;
