...
const Schema: z.ZodType<Prisma.AnnotationUncheckedCreateNestedManyWithoutEntryInput> = z
	.object({
		create: z
			.union([
...
export const AnnotationUncheckedCreateNestedManyWithoutEntryInputObjectSchema = Schema;
