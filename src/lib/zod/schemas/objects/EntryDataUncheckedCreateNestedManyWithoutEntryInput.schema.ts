...
const Schema: z.ZodType<Prisma.EntryDataUncheckedCreateNestedManyWithoutEntryInput> = z
	.object({
		create: z
			.union([
...
export const EntryDataUncheckedCreateNestedManyWithoutEntryInputObjectSchema = Schema;
