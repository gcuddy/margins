...
const Schema: z.ZodType<Prisma.InteractionUncheckedUpdateManyWithoutUserNestedInput> = z
	.object({
		create: z
			.union([
...
export const InteractionUncheckedUpdateManyWithoutUserNestedInputObjectSchema = Schema;
