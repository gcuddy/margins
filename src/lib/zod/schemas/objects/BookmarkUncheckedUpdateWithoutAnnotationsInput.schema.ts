...
const Schema: z.ZodType<Prisma.BookmarkUncheckedUpdateWithoutAnnotationsInput> = z
	.object({
...
export const BookmarkUncheckedUpdateWithoutAnnotationsInputObjectSchema = Schema;
