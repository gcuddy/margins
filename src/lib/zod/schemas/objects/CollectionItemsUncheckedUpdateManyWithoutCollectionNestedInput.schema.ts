...
const Schema: z.ZodType<Prisma.CollectionItemsUncheckedUpdateManyWithoutCollectionNestedInput> = z
	.object({
		create: z
			.union([
...
export const CollectionItemsUncheckedUpdateManyWithoutCollectionNestedInputObjectSchema = Schema;
