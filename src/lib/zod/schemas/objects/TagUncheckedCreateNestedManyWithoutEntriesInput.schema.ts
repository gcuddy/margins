...
const Schema: z.ZodType<Prisma.TagUncheckedCreateNestedManyWithoutEntriesInput> = z
	.object({
		create: z
			.union([
...
export const TagUncheckedCreateNestedManyWithoutEntriesInputObjectSchema = Schema;
