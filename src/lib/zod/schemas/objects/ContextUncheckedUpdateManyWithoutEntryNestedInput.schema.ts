...
const Schema: z.ZodType<Prisma.ContextUncheckedUpdateManyWithoutEntryNestedInput> = z
	.object({
		create: z
			.union([
...
export const ContextUncheckedUpdateManyWithoutEntryNestedInputObjectSchema = Schema;
