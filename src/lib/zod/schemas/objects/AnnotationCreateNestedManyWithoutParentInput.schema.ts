...
const Schema: z.ZodType<Prisma.AnnotationCreateNestedManyWithoutParentInput> = z
	.object({
		create: z
			.union([
...
export const AnnotationCreateNestedManyWithoutParentInputObjectSchema = Schema;
