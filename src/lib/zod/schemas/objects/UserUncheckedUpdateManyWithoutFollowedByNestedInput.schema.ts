...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateManyWithoutFollowedByNestedInput> = z
	.object({
		create: z
			.union([
...
export const UserUncheckedUpdateManyWithoutFollowedByNestedInputObjectSchema = Schema;
