...
const Schema: z.ZodType<Prisma.CollectionItemsUncheckedUpdateManyWithoutItemsInput> = z
	.object({
...
export const CollectionItemsUncheckedUpdateManyWithoutItemsInputObjectSchema = Schema;
