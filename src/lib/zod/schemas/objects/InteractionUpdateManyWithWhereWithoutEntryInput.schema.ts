...
const Schema: z.ZodType<Prisma.InteractionUpdateManyWithWhereWithoutEntryInput> = z
	.object({
...
export const InteractionUpdateManyWithWhereWithoutEntryInputObjectSchema = Schema;
