...
const Schema: z.ZodType<Prisma.FavoriteFolderUncheckedCreateNestedManyWithoutUserInput> = z
	.object({
		create: z
			.union([
...
export const FavoriteFolderUncheckedCreateNestedManyWithoutUserInputObjectSchema = Schema;
