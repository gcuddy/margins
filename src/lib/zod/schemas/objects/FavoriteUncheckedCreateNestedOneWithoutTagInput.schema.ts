...
const Schema: z.ZodType<Prisma.FavoriteUncheckedCreateNestedOneWithoutTagInput> = z
	.object({
		create: z
			.union([
...
export const FavoriteUncheckedCreateNestedOneWithoutTagInputObjectSchema = Schema;
