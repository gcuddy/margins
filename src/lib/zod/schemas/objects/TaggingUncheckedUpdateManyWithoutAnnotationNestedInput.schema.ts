...
const Schema: z.ZodType<Prisma.TaggingUncheckedUpdateManyWithoutAnnotationNestedInput> = z
	.object({
		create: z
			.union([
...
export const TaggingUncheckedUpdateManyWithoutAnnotationNestedInputObjectSchema = Schema;
