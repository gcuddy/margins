...
const Schema: z.ZodType<Prisma.BookmarkUpdateManyWithWhereWithoutUserInput> = z
	.object({
...
export const BookmarkUpdateManyWithWhereWithoutUserInputObjectSchema = Schema;
