...
import { NestedEnumLocationNullableWithAggregatesFilterObjectSchema } from './NestedEnumLocationNullableWithAggregatesFilter.schema';
import { NestedIntNullableFilterObjectSchema } from './NestedIntNullableFilter.schema';
import { NestedEnumLocationNullableFilterObjectSchema } from './NestedEnumLocationNullableFilter.schema';

import type { Prisma } from '@prisma/client';

const Schema: z.ZodType<Prisma.EnumLocationNullableWithAggregatesFilter> = z
	.object({
		equals: z
...
export const EnumLocationNullableWithAggregatesFilterObjectSchema = Schema;
