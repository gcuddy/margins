...
const Schema: z.ZodType<Prisma.EntryUncheckedCreateWithoutAnnotationsInput> = z
	.object({
...
export const EntryUncheckedCreateWithoutAnnotationsInputObjectSchema = Schema;
