...
const Schema: z.ZodType<Prisma.ContextUncheckedCreateNestedManyWithoutFeedInput> = z
	.object({
		create: z
			.union([
...
export const ContextUncheckedCreateNestedManyWithoutFeedInputObjectSchema = Schema;
