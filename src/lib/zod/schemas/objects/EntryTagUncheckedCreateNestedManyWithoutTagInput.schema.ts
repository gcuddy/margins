...
const Schema: z.ZodType<Prisma.EntryTagUncheckedCreateNestedManyWithoutTagInput> = z
	.object({
		create: z
			.union([
...
export const EntryTagUncheckedCreateNestedManyWithoutTagInputObjectSchema = Schema;
