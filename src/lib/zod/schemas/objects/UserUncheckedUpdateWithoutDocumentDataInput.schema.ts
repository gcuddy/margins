...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutDocumentDataInput> = z
	.object({
		id: z
...
export const UserUncheckedUpdateWithoutDocumentDataInputObjectSchema = Schema;
