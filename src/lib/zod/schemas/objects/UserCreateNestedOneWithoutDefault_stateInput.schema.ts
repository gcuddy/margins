...
const Schema: z.ZodType<Prisma.UserCreateNestedOneWithoutDefault_stateInput> = z
	.object({
		create: z
			.union([
...
export const UserCreateNestedOneWithoutDefault_stateInputObjectSchema = Schema;
