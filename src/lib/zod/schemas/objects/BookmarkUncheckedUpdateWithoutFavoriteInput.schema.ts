...
const Schema: z.ZodType<Prisma.BookmarkUncheckedUpdateWithoutFavoriteInput> = z
	.object({
...
export const BookmarkUncheckedUpdateWithoutFavoriteInputObjectSchema = Schema;
