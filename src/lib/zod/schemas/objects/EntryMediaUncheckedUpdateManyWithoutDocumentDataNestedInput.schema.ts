...
const Schema: z.ZodType<Prisma.EntryMediaUncheckedUpdateManyWithoutDocumentDataNestedInput> = z
	.object({
		create: z
			.union([
...
export const EntryMediaUncheckedUpdateManyWithoutDocumentDataNestedInputObjectSchema = Schema;
