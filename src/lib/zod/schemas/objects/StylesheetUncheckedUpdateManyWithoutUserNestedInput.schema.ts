...
const Schema: z.ZodType<Prisma.StylesheetUncheckedUpdateManyWithoutUserNestedInput> = z
	.object({
		create: z
			.union([
...
export const StylesheetUncheckedUpdateManyWithoutUserNestedInputObjectSchema = Schema;
