...
import { EntryUpdateOneRequiredWithoutDataNestedInputObjectSchema } from './EntryUpdateOneRequiredWithoutDataNestedInput.schema';
...
const Schema: z.ZodType<Prisma.EntryDataUpdateWithoutMediaInput> = z
	.object({
		html: z
		...
		updatedAt: z
			.union([z.date(), z.lazy(() => DateTimeFieldUpdateOperationsInputObjectSchema)])
			.optional(),
		entry: z.lazy(() => EntryUpdateOneRequiredWithoutDataNestedInputObjectSchema).optional(),
		user: z.lazy(() => UserUpdateOneRequiredWithoutDocumentDataNestedInputObjectSchema).optional(),
	})
	.strict();

export const EntryDataUpdateWithoutMediaInputObjectSchema = Schema;
