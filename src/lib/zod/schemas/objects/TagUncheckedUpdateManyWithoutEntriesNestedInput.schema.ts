...
const Schema: z.ZodType<Prisma.TagUncheckedUpdateManyWithoutEntriesNestedInput> = z
	.object({
		create: z
			.union([
...
export const TagUncheckedUpdateManyWithoutEntriesNestedInputObjectSchema = Schema;
