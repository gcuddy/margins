...
const Schema: z.ZodType<Prisma.BookmarkUncheckedUpdateWithoutCollectionsInput> = z
	.object({
...
export const BookmarkUncheckedUpdateWithoutCollectionsInputObjectSchema = Schema;
