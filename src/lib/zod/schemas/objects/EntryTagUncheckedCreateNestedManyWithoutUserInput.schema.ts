...
const Schema: z.ZodType<Prisma.EntryTagUncheckedCreateNestedManyWithoutUserInput> = z
	.object({
		create: z
			.union([
...
export const EntryTagUncheckedCreateNestedManyWithoutUserInputObjectSchema = Schema;
