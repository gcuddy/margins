...
const Schema: z.ZodType<Prisma.UserUncheckedCreateNestedManyWithoutFollowingInput> = z
	.object({
		create: z
			.union([
...
export const UserUncheckedCreateNestedManyWithoutFollowingInputObjectSchema = Schema;
