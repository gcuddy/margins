...
const Schema: z.ZodType<Prisma.FavoriteFolderUncheckedUpdateWithoutUserInput> = z
	.object({
...
export const FavoriteFolderUncheckedUpdateWithoutUserInputObjectSchema = Schema;
