...
const Schema: z.ZodType<Prisma.BookmarkUncheckedUpdateOneWithoutInteractionNestedInput> = z
	.object({
		create: z
			.union([
...
export const BookmarkUncheckedUpdateOneWithoutInteractionNestedInputObjectSchema = Schema;
