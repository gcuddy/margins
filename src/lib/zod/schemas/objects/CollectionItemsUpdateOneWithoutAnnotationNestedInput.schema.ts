...
const Schema: z.ZodType<Prisma.CollectionItemsUpdateOneWithoutAnnotationNestedInput> = z
	.object({
		create: z
			.union([
...
export const CollectionItemsUpdateOneWithoutAnnotationNestedInputObjectSchema = Schema;
