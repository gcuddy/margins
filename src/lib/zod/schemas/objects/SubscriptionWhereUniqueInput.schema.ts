import { z } from 'zod';
import { SubscriptionUserIdFeedIdCompoundUniqueInputObjectSchema } from './SubscriptionUserIdFeedIdCompoundUniqueInput.schema';
...
const Schema: z.ZodType<Prisma.SubscriptionWhereUniqueInput> = z
	.object({
		...
		userId_feedId: z.lazy(() => SubscriptionUserIdFeedIdCompoundUniqueInputObjectSchema).optional(),
		AND: z
			.union([
