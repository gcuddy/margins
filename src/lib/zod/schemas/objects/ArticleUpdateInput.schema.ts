...
import { UserUpdateOneRequiredWithoutArticlesNestedInputObjectSchema } from './UserUpdateOneRequiredWithoutArticlesNestedInput.schema';
...
const Schema: z.ZodType<Prisma.ArticleUpdateInput> = z
	.object({
		...
		user: z.lazy(() => UserUpdateOneRequiredWithoutArticlesNestedInputObjectSchema).optional(),
		favoriteId: z
			.union([z.number(), z.lazy(() => NullableIntFieldUpdateOperationsInputObjectSchema)])
			.optional()
			.nullable(),
