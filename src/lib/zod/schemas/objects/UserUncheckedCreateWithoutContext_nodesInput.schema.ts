...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutContext_nodesInput> = z
	.object({
...
export const UserUncheckedCreateWithoutContext_nodesInputObjectSchema = Schema;
