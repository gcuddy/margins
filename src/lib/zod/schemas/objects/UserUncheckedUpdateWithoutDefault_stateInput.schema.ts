...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutDefault_stateInput> = z
	.object({
		id: z
...
export const UserUncheckedUpdateWithoutDefault_stateInputObjectSchema = Schema;
