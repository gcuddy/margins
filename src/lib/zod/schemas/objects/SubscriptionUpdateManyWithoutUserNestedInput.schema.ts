...
const Schema: z.ZodType<Prisma.SubscriptionUpdateManyWithoutUserNestedInput> = z
	.object({
		create: z
			.union([
...
export const SubscriptionUpdateManyWithoutUserNestedInputObjectSchema = Schema;
