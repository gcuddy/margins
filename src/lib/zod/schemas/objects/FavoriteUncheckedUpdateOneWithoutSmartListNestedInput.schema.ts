...
const Schema: z.ZodType<Prisma.FavoriteUncheckedUpdateOneWithoutSmartListNestedInput> = z
	.object({
		create: z
			.union([
...
export const FavoriteUncheckedUpdateOneWithoutSmartListNestedInputObjectSchema = Schema;
