...
const Schema: z.ZodType<Prisma.EntryUncheckedCreateWithoutInteractionsInput> = z
	.object({
...
export const EntryUncheckedCreateWithoutInteractionsInputObjectSchema = Schema;
