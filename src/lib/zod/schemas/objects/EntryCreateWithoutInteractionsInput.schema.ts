...
import { EntryTagCreateNestedManyWithoutEntryInputObjectSchema } from './EntryTagCreateNestedManyWithoutEntryInput.schema';
...
const Schema: z.ZodType<Prisma.EntryCreateWithoutInteractionsInput> = z
	.object({
		...
		entrytags: z.lazy(() => EntryTagCreateNestedManyWithoutEntryInputObjectSchema).optional(),
		context: z.lazy(() => ContextCreateNestedManyWithoutEntryInputObjectSchema).optional(),
	})
	.strict();

export const EntryCreateWithoutInteractionsInputObjectSchema = Schema;
