...
import { NestedEnumLocationWithAggregatesFilterObjectSchema } from './NestedEnumLocationWithAggregatesFilter.schema';
import { NestedIntFilterObjectSchema } from './NestedIntFilter.schema';
import { NestedEnumLocationFilterObjectSchema } from './NestedEnumLocationFilter.schema';

import type { Prisma } from '@prisma/client';

const Schema: z.ZodType<Prisma.EnumLocationWithAggregatesFilter> = z
	.object({
		equals: z
...
export const EnumLocationWithAggregatesFilterObjectSchema = Schema;
