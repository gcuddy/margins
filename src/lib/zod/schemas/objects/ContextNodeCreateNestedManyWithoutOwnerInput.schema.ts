...
const Schema: z.ZodType<Prisma.ContextNodeCreateNestedManyWithoutOwnerInput> = z
	.object({
		create: z
			.union([
...
export const ContextNodeCreateNestedManyWithoutOwnerInputObjectSchema = Schema;
