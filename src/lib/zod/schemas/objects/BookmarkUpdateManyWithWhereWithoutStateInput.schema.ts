...
const Schema: z.ZodType<Prisma.BookmarkUpdateManyWithWhereWithoutStateInput> = z
	.object({
...
export const BookmarkUpdateManyWithWhereWithoutStateInputObjectSchema = Schema;
