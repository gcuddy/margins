import { z } from 'zod';
import { InteractionUserIdEntryIdCompoundUniqueInputObjectSchema } from './InteractionUserIdEntryIdCompoundUniqueInput.schema';
...
const Schema: z.ZodType<Prisma.InteractionWhereUniqueInput> = z
	.object({
		id: z.number().optional(),
		userId_entryId: z
			.lazy(() => InteractionUserIdEntryIdCompoundUniqueInputObjectSchema)
			.optional(),
		AND: z
			.union([
...
export const InteractionWhereUniqueInputObjectSchema = Schema;
