...
const Schema: z.ZodType<Prisma.AnnotationCreateNestedManyWithoutCreatorInput> = z
	.object({
		create: z
			.union([
...
export const AnnotationCreateNestedManyWithoutCreatorInputObjectSchema = Schema;
