...
import { NestedEnumCollectionItemTypeWithAggregatesFilterObjectSchema } from './NestedEnumCollectionItemTypeWithAggregatesFilter.schema';
import { NestedIntFilterObjectSchema } from './NestedIntFilter.schema';
import { NestedEnumCollectionItemTypeFilterObjectSchema } from './NestedEnumCollectionItemTypeFilter.schema';

import type { Prisma } from '@prisma/client';

const Schema: z.ZodType<Prisma.EnumCollectionItemTypeWithAggregatesFilter> = z
	.object({
		equals: z
			.union([
...
export const EnumCollectionItemTypeWithAggregatesFilterObjectSchema = Schema;
