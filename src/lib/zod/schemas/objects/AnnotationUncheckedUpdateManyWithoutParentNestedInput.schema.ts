...
const Schema: z.ZodType<Prisma.AnnotationUncheckedUpdateManyWithoutParentNestedInput> = z
	.object({
		create: z
			.union([
...
export const AnnotationUncheckedUpdateManyWithoutParentNestedInputObjectSchema = Schema;
