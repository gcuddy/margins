...
const Schema: z.ZodType<Prisma.FavoriteFolderUncheckedUpdateManyWithoutUserNestedInput> = z
	.object({
		create: z
			.union([
...
export const FavoriteFolderUncheckedUpdateManyWithoutUserNestedInputObjectSchema = Schema;
