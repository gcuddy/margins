...
const Schema: z.ZodType<Prisma.CollectionItemsUncheckedCreateNestedOneWithoutAnnotationInput> = z
	.object({
		create: z
			.union([
...
export const CollectionItemsUncheckedCreateNestedOneWithoutAnnotationInputObjectSchema = Schema;
