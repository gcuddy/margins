...
const Schema: z.ZodType<Prisma.CollectionItemsUpdateManyWithoutBookmarkNestedInput> = z
	.object({
		create: z
			.union([
...
export const CollectionItemsUpdateManyWithoutBookmarkNestedInputObjectSchema = Schema;
