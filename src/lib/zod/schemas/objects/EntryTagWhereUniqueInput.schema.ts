import { z } from 'zod';
import { EntryTagEntryIdTagIdUserIdCompoundUniqueInputObjectSchema } from './EntryTagEntryIdTagIdUserIdCompoundUniqueInput.schema';
...
const Schema: z.ZodType<Prisma.EntryTagWhereUniqueInput> = z
	.object({
		entryId_tagId_userId: z
			.lazy(() => EntryTagEntryIdTagIdUserIdCompoundUniqueInputObjectSchema)
			.optional(),
		AND: z
			.union([
...
export const EntryTagWhereUniqueInputObjectSchema = Schema;
