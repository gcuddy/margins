...
const Schema: z.ZodType<Prisma.FavoriteUncheckedUpdateOneWithoutAnnotationNestedInput> = z
	.object({
		create: z
			.union([
...
export const FavoriteUncheckedUpdateOneWithoutAnnotationNestedInputObjectSchema = Schema;
