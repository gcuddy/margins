...
const Schema: z.ZodType<Prisma.BookmarkUncheckedUpdateWithoutInteractionInput> = z
	.object({
...
export const BookmarkUncheckedUpdateWithoutInteractionInputObjectSchema = Schema;
