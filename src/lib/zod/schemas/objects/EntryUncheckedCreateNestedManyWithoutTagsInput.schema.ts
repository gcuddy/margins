...
const Schema: z.ZodType<Prisma.EntryUncheckedCreateNestedManyWithoutTagsInput> = z
	.object({
		create: z
			.union([
...
export const EntryUncheckedCreateNestedManyWithoutTagsInputObjectSchema = Schema;
