...
const Schema: z.ZodType<Prisma.AnnotationUncheckedCreateWithoutCollectionsInput> = z
	.object({
...
export const AnnotationUncheckedCreateWithoutCollectionsInputObjectSchema = Schema;
