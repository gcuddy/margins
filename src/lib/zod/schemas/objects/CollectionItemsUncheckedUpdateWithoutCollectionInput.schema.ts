...
const Schema: z.ZodType<Prisma.CollectionItemsUncheckedUpdateWithoutCollectionInput> = z
	.object({
...
export const CollectionItemsUncheckedUpdateWithoutCollectionInputObjectSchema = Schema;
