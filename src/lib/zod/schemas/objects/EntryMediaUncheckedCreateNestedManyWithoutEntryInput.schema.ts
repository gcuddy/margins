...
const Schema: z.ZodType<Prisma.EntryMediaUncheckedCreateNestedManyWithoutEntryInput> = z
	.object({
		create: z
			.union([
...
export const EntryMediaUncheckedCreateNestedManyWithoutEntryInputObjectSchema = Schema;
