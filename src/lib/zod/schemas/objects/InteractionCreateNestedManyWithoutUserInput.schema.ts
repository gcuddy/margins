...
const Schema: z.ZodType<Prisma.InteractionCreateNestedManyWithoutUserInput> = z
	.object({
		create: z
			.union([
...
export const InteractionCreateNestedManyWithoutUserInputObjectSchema = Schema;
