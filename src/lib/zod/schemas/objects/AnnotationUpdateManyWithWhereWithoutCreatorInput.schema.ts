...
const Schema: z.ZodType<Prisma.AnnotationUpdateManyWithWhereWithoutCreatorInput> = z
	.object({
...
export const AnnotationUpdateManyWithWhereWithoutCreatorInputObjectSchema = Schema;
