...
const Schema: z.ZodType<Prisma.AnnotationUpdateManyWithoutEntryNestedInput> = z
	.object({
		create: z
			.union([
...
export const AnnotationUpdateManyWithoutEntryNestedInputObjectSchema = Schema;
