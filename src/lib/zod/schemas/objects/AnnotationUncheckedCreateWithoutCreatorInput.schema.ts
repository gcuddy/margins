...
const Schema: z.ZodType<Prisma.AnnotationUncheckedCreateWithoutCreatorInput> = z
	.object({
...
export const AnnotationUncheckedCreateWithoutCreatorInputObjectSchema = Schema;
