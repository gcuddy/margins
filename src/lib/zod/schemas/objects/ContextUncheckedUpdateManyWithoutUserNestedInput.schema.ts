...
const Schema: z.ZodType<Prisma.ContextUncheckedUpdateManyWithoutUserNestedInput> = z
	.object({
		create: z
			.union([
...
export const ContextUncheckedUpdateManyWithoutUserNestedInputObjectSchema = Schema;
