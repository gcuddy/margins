...
const Schema: z.ZodType<Prisma.InteractionUpdateManyWithoutEntryNestedInput> = z
	.object({
		create: z
			.union([
...
export const InteractionUpdateManyWithoutEntryNestedInputObjectSchema = Schema;
