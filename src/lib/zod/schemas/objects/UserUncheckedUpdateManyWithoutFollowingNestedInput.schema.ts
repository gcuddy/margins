...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateManyWithoutFollowingNestedInput> = z
	.object({
		create: z
			.union([
...
export const UserUncheckedUpdateManyWithoutFollowingNestedInputObjectSchema = Schema;
