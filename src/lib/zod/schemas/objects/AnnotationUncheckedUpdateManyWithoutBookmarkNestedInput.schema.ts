...
const Schema: z.ZodType<Prisma.AnnotationUncheckedUpdateManyWithoutBookmarkNestedInput> = z
	.object({
		create: z
			.union([
...
export const AnnotationUncheckedUpdateManyWithoutBookmarkNestedInputObjectSchema = Schema;
