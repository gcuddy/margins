...
const Schema: z.ZodType<Prisma.UserUpdateOneWithoutDefault_stateNestedInput> = z
	.object({
		create: z
			.union([
...
export const UserUpdateOneWithoutDefault_stateNestedInputObjectSchema = Schema;
