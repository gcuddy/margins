...
const Schema: z.ZodType<Prisma.BookmarkUncheckedCreateNestedManyWithoutStateInput> = z
	.object({
		create: z
			.union([
...
export const BookmarkUncheckedCreateNestedManyWithoutStateInputObjectSchema = Schema;
