...
const Schema: z.ZodType<Prisma.TaggingUncheckedCreateNestedManyWithoutUserInput> = z
	.object({
		create: z
			.union([
...
export const TaggingUncheckedCreateNestedManyWithoutUserInputObjectSchema = Schema;
