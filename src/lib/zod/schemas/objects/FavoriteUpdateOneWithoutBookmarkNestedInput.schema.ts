...
const Schema: z.ZodType<Prisma.FavoriteUpdateOneWithoutBookmarkNestedInput> = z
	.object({
		create: z
			.union([
...
export const FavoriteUpdateOneWithoutBookmarkNestedInputObjectSchema = Schema;
