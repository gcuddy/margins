...
const Schema: z.ZodType<Prisma.AnnotationUncheckedUpdateManyWithoutCreatorNestedInput> = z
	.object({
		create: z
			.union([
...
export const AnnotationUncheckedUpdateManyWithoutCreatorNestedInputObjectSchema = Schema;
