...
const Schema: z.ZodType<Prisma.FavoriteUncheckedCreateNestedOneWithoutAnnotationInput> = z
	.object({
		create: z
			.union([
...
export const FavoriteUncheckedCreateNestedOneWithoutAnnotationInputObjectSchema = Schema;
