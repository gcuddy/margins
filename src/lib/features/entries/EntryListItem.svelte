...
<a
	href="/u:{$page.data.user?.username}/entry/{entry.id}"
	class:active
	class="item relative flex h-full flex-initial items-center gap-4  p-4  transition"
>
	<div
		class="flex-inital relative flex h-16 w-14 shrink-0 cursor-pointer flex-row  items-center overflow-hidden rounded-md transition hover:ring"
