...
export declare type TRenderProps<TSlotProps extends {}, TAsProp extends SupportedAs, TDefaultAs> = TRestProps<TResolveAs<TAsProp, TDefaultAs>> & {
    name: string;
...
export declare type TInternalProps = "name" | "slotProps" | "el" | "visible" | "features";
export declare type TPassThroughProps<TSlotProps extends {}, TAsProp extends SupportedAs, TDefaultAs> = Omit<TRenderProps<TSlotProps, TAsProp, TDefaultAs>, TInternalProps | "as" | "static" | "unmount"> & {
