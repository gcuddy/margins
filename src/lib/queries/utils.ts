import { type QueryClient, createQuery, type CreateQueryOptions, type CreateQueryResult, type QueryKey, type DefinedCreateQueryResult, createInfiniteQuery, type CreateInfiniteQueryOptions, type CreateInfiniteQueryResult, type DefaultError, type InfiniteData, type WritableOrVal } from "@tanstack/svelte-query";
...
export async function loadQuery<TOutput, TError, TFnOutput = TOutput, TQueryKey extends QueryKey = QueryKey>(queryClient: QueryClient, opts: CreateQueryOptions<TOutput, TError, TFnOutput, TQueryKey> & {
...
export async function loadInfiniteQuery<TQueryFnData = unknown, TError = unknown, TData = TQueryFnData, TQueryKey extends QueryKey = QueryKey>(queryClient: QueryClient, opts: CreateInfiniteQueryOptions<TQueryFnData, TError, InfiniteData<TData>, TQueryFnData, TQueryKey> & {
...
export function createInfiniteQueryOptions<TQueryFnData = unknown, TError = unknown, TData = TQueryFnData, TQueryKey extends QueryKey = QueryKey>(opts: CreateInfiniteQueryOptions<TQueryFnData, TError, InfiniteData<TData>, TQueryFnData, TQueryKey> & {
    queryKey: NonNullable<CreateInfiniteQueryOptions['queryKey']>;
    // ssr?: boolean;
}) {
    return opts;
 ...
 */
export async function server_infinite_query<TQueryFnData = unknown, TError = unknown, TData = TQueryFnData, TQueryKey extends QueryKey = QueryKey>(queryClient: QueryClient, opts: CreateInfiniteQueryOptions<TQueryFnData, TError, InfiniteData<TData>, TQueryFnData, TQueryKey> & {
    queryKey: NonNullable<CreateInfiniteQueryOptions['queryKey']>;
    // ssr?: boolean;
}) {
    const { queryKey } = opts;
...
export function infiniteQueryOptions<
    ...
    TPageParam = unknown
>(
    options: WritableOrVal<CreateInfiniteQueryOptions<TQueryFnData, TError, TData, TQueryFnData, TQueryKey, TPageParam>>
): WritableOrVal<CreateInfiniteQueryOptions<TQueryFnData, TError, TData, TQueryFnData, TQueryKey, TPageParam>>;
