<script lang="ts">
	...
	export let checked = value === options[0];
...
<!-- taken from https://github.com/the-pudding/svelte-starter/blob/main/src/components/helpers/Toggle.svelte -->
<!-- WAI-ARIA: https://www.w3.org/TR/2021/NOTE-wai-aria-practices-1.2-20211129/#switch -->
