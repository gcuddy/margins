...
<div
	bind:this={el}
	class="annotation-input not-prose relative z-50 flex w-[min(300px,100vh)] max-w-md resize scroll-mt-12 flex-col items-start gap-2.5 rounded-lg border border-gray-200 bg-white p-2.5 font-sans   transition-shadow transparency:bg-gray-50/90 transparency:backdrop-blur-xl transparency:backdrop-brightness-125 transparency:backdrop-saturate-200 dark:border-0 dark:bg-gray-800 dark:ring-1  dark:ring-gray-400/10 focus-within:dark:ring-gray-400/20  transparency:dark:bg-gray-800 {className} {shadow_focus &&
	focused
		? 'shadow-lg'
		: shadow_focus
		? 'shadow'
