...
<div
	bind:this={el}
	class="annotation-input not-prose relative z-50 flex max-w-md cursor-default resize scroll-mt-12 flex-col items-start gap-2.5 rounded-lg  border border-gray-300 bg-white p-2.5 font-sans font-medium shadow-lg dark:border-gray-700 dark:bg-gray-800 dark:shadow-2xl "
>
	...
	<div class="flex grow items-center">
		<TagEntry bind:tags className="grow text-xs not-italic" allTags={$page.data.user.tags} />
	</div>
