...
import { textQuoteSelectorMatcher as abstractTextQuoteSelectorMatcher } from './abstract/match-text-quote.js';
import { textPositionSelectorMatcher as abstractTextPositionSelectorMatcher } from './abstract/match-text-position.js';
import { describeTextQuote as abstractDescribeTextQuote } from './abstract/text-quote.js';
import { describeTextPosition as abstractDescribeTextPosition } from './abstract/text-position.js';

import { EmptyScopeError, TextNodeChunker } from './chunk.js';
import { isTextNode } from './highlighter/index.js';
import { buildSelectorFromImage } from './img.js';
import type {
	CssSelector,
...
import { ownerDocument, toRange } from './utils.js';
