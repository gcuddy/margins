...
export class Annotation extends Model.Class<Annotation>("Annotation")({
  ...
  editedAt: Model.FieldOption(DateTimeStringWithoutDefault),
  ...
  due_timestamp: Model.FieldOption(DateTimeStringWithoutDefault),
  interval_ms: Model.FieldOption(Schema.BigInt),
  last_reviewed_at: Model.FieldOption(DateTimeStringWithoutDefault),
  srs: Model.Field(Schema.Boolean),
  srs_created_at: Model.FieldOption(DateTimeStringWithoutDefault),
