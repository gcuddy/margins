// https://github.com/tailwindlabs/headlessui/blob/main/packages/%40headlessui-vue/src/utils/focus-management.ts
...
export function focusIn(
	...
	do {
		...
		if (offset >= total || offset + total <= 0) throw Error('Infinite loop detected');
