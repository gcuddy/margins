...
import type { Chunk, Chunker, ChunkRange } from '../chunk';
import { chunkRangeEquals } from '../chunk';
...
function readUntilWhitespace(seeker: RelativeSeeker, limit = Infinity, reverse = false): string {
	let result = '';
