...
import type { Chunk, Chunker } from '../chunk';
import { chunkEquals } from '../chunk';
 ...
 * @public
 */
export interface Seeker<TChunk extends Chunk<any>, TData extends Iterable<any> = string>
 ...
 * @public
 */
export interface ChunkSeeker<TChunk extends Chunk<any>, TData extends Iterable<any> = string> {
	/**
 ...
 * @public
 */
export class TextSeeker<TChunk extends Chunk<string>> implements Seeker<TChunk> {
	...
	private _readOrSeekToChunk(read: boolean, target: TChunk, offset = 0): string | void {
